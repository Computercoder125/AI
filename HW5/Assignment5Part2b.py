...
GAMMA = 0.8          # Discount Factor (how much future rewards matter)
...
EPS_DECAY = 50           # Keeping this aggressive decay value as requested
...
def run_visualizer():
    ...
    episode_rewards = [] #initializing array to put reward values in
    # --- Model Loading Logic ---
    is_trained = False
    ...
    while running:
        ...
        if not done:
            ...
            if done:
                ...
                # Print in CSV style: easy to paste into Sheets
